...
from engine_acdc import train_one_epoch, val_one_epoch, test_pth

from models.WGambaNet.wgamba_model import WgambaNet
...
from utils import *
# from configs.config_setting_synapse_other import setting_config
# from configs.config_setting_synapse_unet import setting_config
...
def main(config):
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        if epoch % config.val_interval == 0:
            ...
            mean_dice, mean_rv, mean_myo, mean_lv, mean_hd95 = mean_metrics
    ...
    if os.path.exists(os.path.join(checkpoint_dir, 'best.pth')):
        ...
        os.rename(
            ...
            os.path.join(checkpoint_dir,
                         f'best-epoch{min_epoch}-mean_dice{mean_dice:.4f}-mean_rv{mean_rv:.4f}.pth')
        )
